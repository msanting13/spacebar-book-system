...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="/site-template/vendors/feather/feather.css"
        />
        <link
            rel="stylesheet"
            href="/site-template/vendors/mdi/css/materialdesignicons.min.css"
        />
        <link
            rel="stylesheet"
            href="/site-template/vendors/ti-icons/css/themify-icons.css"
        />
        <link
            rel="stylesheet"
            href="/site-template/vendors/typicons/typicons.css"
        />
        <link
            rel="stylesheet"
            href="/site-template/vendors/simple-line-icons/css/simple-line-icons.css"
        />
        <link
            rel="stylesheet"
            href="/site-template/vendors/css/vendor.bundle.base.css"
        />
        <!-- endinject -->
        ...
        <link
            rel="stylesheet"
            href="/site-template/css/vertical-layout-light/style.css"
        />
        <!-- endinject -->
                        ...
                        <div class="col-lg-4 mx-auto">
                            ...
                            >
                                <div class="brand-logo">
                                    {{--
                                    <img
                                        src="/site-template/images/logo.svg"
                                        alt="logo"
                                    />
                                    --}}
                                    <h2>Login</h2>
