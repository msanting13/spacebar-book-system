                        ...
                        <div class="row g-8 row-cols-1 row-cols-sm-2">
                            ...
                            <div class="col">
                                <div class="bg-body shadow-xs rounded text-center p-7">
                                    ...
                                    <!--end::Symbol-->
                                    <a href="#"
                                        class="text-gray-800 text-hover-primary fw-boldest fs-5 mt-4 d-block">Function Halls</a>
                                </div>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
        ...
        <div class="col-xxl-4">
            ...
            <div class="card card-xxl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header align-items-center border-0 mt-5">
                    <!--begin::Card title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="fw-boldest text-dark fs-2">Customers</span>
                ...
                <div class="card-body pt-1">
                    ...
                    <div class="d-flex flex-stack item-border-hover px-3 py-2 ms-n4 mb-6">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="ps-1 mb-1">
                                <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-boldest">{{ $user->first_name }} {{ $user->last_name }}</a>
                            </div>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
