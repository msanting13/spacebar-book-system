													...
													<div class="row g-8 row-cols-1 row-cols-sm-2">
														...
														<div class="col mt-sm-n2">
															<div class="bg-body shadow-xs rounded text-center p-7">
																...
																<a href="#" class="text-gray-800 text-hover-primary fw-boldest fs-5 mt-4 d-block">Extras</a>
															</div>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col">
															<div class="bg-body shadow-xs rounded text-center p-7">
																...
																<!--end::Symbol-->
																<a href="#" class="text-gray-800 text-hover-primary fw-boldest fs-5 mt-4 d-block">Users</a>
															</div>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
